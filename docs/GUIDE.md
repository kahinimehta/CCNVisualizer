...
**Before deployment:** manually check scraped text, theme labels, and spot-fix outliers in `abstracts_2_topics.csv` / `submissions.json` (production data was cleaned this way).
